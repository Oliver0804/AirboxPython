...
try: 
    ...
    print(result)
    cur.execute("INSERT INTO `Data` (`time`, `pm10`, `formaldehyde`, `vocs`, `co2`, `temp`, `humidity`, `battery`, `runtime`, `air3um`, `air5um`, `air10um`, `air25um`, `air50um`, `air100um`) VALUES ('?', '?', '?', '?', '?', '?','?','?','?','?','?','?','?','?','?');",(result,20,30,40,50,60,70,80,90,100,110,111,112,113,114))
except mariadb.Error as e: 
    print(f"Error: {e}") 
conn.commit() 
conn.close()
